'''
You are given two integer arrays nums1 and nums2, sorted in ascending order, and two integers m and n, representing the number
...
class Solution:
    def merge(self, nums1: list[int], m: int, nums2: list[int], n: int) -> None:
        ...
        #looping until J = -1, all second array elements have been transfered to first array 
        while j >= 0:
...
#example run of solution
soln = Solution()
soln.merge([1, 3, 5, 0, 0, 0], 3, [2, 4, 6], 3)
